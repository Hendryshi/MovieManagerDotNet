...
namespace DataBaseManager.Common
{
    ...
    /// </summary>
    public class SqlHelper : DapperHelper, IDisposable
	{
		...
		protected SqlHelper(SqlHelper src)
		{
			if(src == null)
			{
		...
		{
			var fromConnectionStrings = System.Configuration.ConfigurationManager.ConnectionStrings["DbJAV"];
			return fromConnectionStrings.ConnectionString;
		}
        ...
        public static void SqlBulkCopyWithTran(string connectionString, string TableName, DataTable dt)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
